      ...
      <div class="label-inner">
        ...
        <div class="logo-section">
          <svg class="logo" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <rect x="4" y="4" width="92" height="92" rx="12" stroke="black" stroke-width="4" fill="white"/>
            <!-- Top bar -->
            <rect x="25" y="20" width="50" height="8" rx="2" fill="black"/>
            <!-- Center piece / spindle holder -->
            <rect x="40" y="28" width="20" height="12" fill="black"/>
            <!-- Spindle body -->
            <path d="M42 40 L42 55 L35 70 L65 70 L58 55 L58 40 Z" fill="black"/>
            <!-- Bit tip -->
            <path d="M45 70 L50 82 L55 70 Z" fill="black"/>
          </svg>
